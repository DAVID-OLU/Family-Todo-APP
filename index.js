...
// let items = [
//     { id: 1, title: "buy milk" },
//     { id: 2, title: "finish coding project" },
// ];

// // async function allItems() {
// //     const result = await db.query(
// //       "SELECT * FROM items JOIN members ON members.id = member_id WHERE member_id = $1; ",
// //       [currentMemberId]
// //     );
// //   }
...
//     try {
//         await db.query("UPDATE items SET title = ($1) WHERE id = $2", [task, id]);
//         res.redirect("/");
//     } catch (err) {
//         console.log(err);
//     }
